...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHANNEL 💠', url='https://t.me/evaenmariyabots'),
            InlineKeyboardButton('💠 GROUP 💠', url='https://t.me/AnyMoviezRequest'),
            InlineKeyboardButton('💠 UPDATES 💠', url='https://t.me/evaenmariyabots')
            ],[      
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🌐 ONLINE PLAYER  🌐', url='https://t.me/faisalkvr'),
        ...
        buttons= [[
            InlineKeyboardButton('♥️ SOURCE ♥️', url='https://t.me/faisalkvr')
            ],[
            InlineKeyboardButton('🏠 𝗛𝗼𝗺𝗲 🏠', callback_data='start'),
